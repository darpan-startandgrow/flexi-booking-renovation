...
$formats[]         = '%s';
return (bool) $this->db->update_row( 'OPTION_SET', 'id', $set_id, $set, $formats, [ '%d' ] );
}
...
$this->db->delete_where( 'OPTION_VALUE', [ 'option_set_id' => $set_id ], [ '%d' ] );
return $this->db->remove_row( 'OPTION_SET', 'id', $set_id, [ '%d' ] );
}
...
return $this->db->get_row( 'OPTION_SET', $set_id );
}
...
$set['updated_at'] = current_time( 'mysql' );
$formats[]         = '%s';
return (bool) $this->db->update_row( 'OPTION_VALUE', 'id', $value_id, $set, $formats, [ '%d' ] );
}
...
return $this->db->remove_row( 'OPTION_VALUE', 'id', $value_id, [ '%d' ] );
}
...
return $this->db->get_row( 'OPTION_VALUE', $value_id );
}
...
$table = $this->db->get_table_name( 'OPTION_VALUE' );
return $this->db->get_results_raw(
$this->db->prepare_sql(
