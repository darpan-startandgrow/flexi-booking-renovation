        ...
        if ( isset( $order->has_extra ) && $order->has_extra == 1 ) {
            ...
            if ( $extra_svc_ids !== 0 ) {
                ...
                foreach ( $merged_extra_ids as $key => $extra_id ) {
                    // Determine extra_type from EXTRASLOTCOUNT for this booking (may be 'local' or 'global').
                    ...
                    // Fetch details from the correct table based on type.
            ...
            if ( !empty( $booking_fields ) ) {
                if ( ( $bmrequests->bm_check_if_cart_order_is_still_bookable( $booking_key ) ) ) {
                    ...
                    if ( isset( $order_post['has_extra'] ) ) {
                        ...
                        // extra_types_booked is a comma-separated list passed from the hidden field.
        ...
        <table class="form-table" role="presentation" id="order_table">
            ...
            <tr class="service_extras" <?php echo !empty( $id ) && ( $order->has_extra == 1 ) ? '' : 'style="display :none;"'; ?>>
                ...
                <input type="hidden" name="extra_types_booked" id="extra_types_booked" value="<?php
                    // Pre-populate extra_types_booked from the saved booking field or from extra_content.
